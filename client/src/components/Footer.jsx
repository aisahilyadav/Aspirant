      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          ...
          <div className="col-span-1 md:col-span-2">
            <div className="mb-4">
              <h3 className="text-2xl font-black tracking-tight">ASPIRANT</h3>
            </div>
            <p className="text-gray-400 mb-6 max-w-md">
              AI-powered learning platform that transforms your study materials into 
              personalized learning experiences with smart quizzes and progress tracking.
            </p>
          ...
          <div>
            ...
            <ul className="space-y-2">
              ...
              <li><Link to="/quiz" className="text-gray-400 hover:text-white transition-colors duration-200">Quiz</Link></li>
        ...
        <div className="border-t border-gray-800 mt-8 pt-8 flex flex-col md:flex-row justify-between items-center">
          <div className="text-gray-400 text-sm">
            © 2025 ASPIRANT. All rights reserved.
          </div>
