...
export default function FeaturesSection() {
  return (
    <div className="relative min-h-screen flex flex-col justify-center items-center px-6 py-24 bg-[#FAF9F6] select-none overflow-hidden animate-fade-in">
      <div className="max-w-5xl w-full mx-auto relative z-10 space-y-12">
        ...
        <div className="space-y-4 max-w-3xl mx-auto text-center">
          ...
          <h2 className="text-3xl sm:text-5xl font-sans font-black text-stone-950 tracking-tight leading-[1.1] uppercase">
        ...
        {/* Floating cards playground (Aligned in a responsive Grid Layout on reload) */}
        <div className="w-full py-6">
          <DraggableCardContainer className="grid grid-cols-1 md:grid-cols-12 gap-6 w-full overflow-visible">
            
            {/* Card 1: Interactive AI Quiz (Wide, Top) */}
            <div className="col-span-12 flex justify-center">
              <DraggableCardBody
                className="w-full bg-[#dbe4ff] [background-size:20px_20px] [background-image:linear-gradient(to_right,rgba(28,25,23,0.06)_1px,transparent_1px),linear-gradient(to_bottom,rgba(28,25,23,0.06)_1px,transparent_1px)] p-6 flex flex-col justify-between transition-shadow duration-300 border-2 border-stone-900 shadow-[4px_4px_0px_0px_rgba(0,0,0,1)]"
              >
                <div className="grid grid-cols-1 sm:grid-cols-12 gap-6 items-stretch">
                  
                  {/* Left Side: Title & Mascot */}
                  <div className="sm:col-span-7 flex flex-col justify-between gap-6">
                    ...
                    <div className="flex justify-start">
                      <svg className="w-36 h-20 text-stone-950" viewBox="0 0 160 100" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
                  ...
                  <div className="sm:col-span-5 flex flex-col justify-between items-start text-left sm:pl-6 border-t sm:border-t-0 sm:border-l border-stone-900/10 pt-4 sm:pt-0">
                    <TextGenerateEffect 
                      ...
                      className="text-xs text-stone-700 leading-relaxed font-semibold" 
                    />
                    <button className="px-4 py-2 bg-stone-900 text-white font-mono text-[9px] font-black uppercase tracking-wider rounded-lg border-2 border-stone-950 shadow-[2.5px_2.5px_0px_0px_#F8C537] hover:translate-x-[-1px] hover:translate-y-[-1px] active:translate-x-[1px] active:translate-y-[1px] active:shadow-none transition-all mt-4">
                      Try for free →
                    </button>
                  </div>
            ...
            {/* Card 2: Rich Notes Canvas (Tall, Left) */}
            <div className="col-span-12 md:col-span-5">
              <DraggableCardBody
                className="w-full h-[360px] bg-gradient-to-b from-[#4fa8ff] to-[#b3dbff] p-6 flex flex-col justify-between border-2 border-stone-900 shadow-[4px_4px_0px_0px_rgba(0,0,0,1)]"
              >
                ...
                <div className="space-y-3 text-left">
                  ...
                  <h3 className="text-base font-black text-stone-950 uppercase tracking-tight leading-tight">
                    Rich Notes Canvas
                  </h3>
                  <TextGenerateEffect 
                    ...
                    className="text-xs text-stone-800 leading-relaxed font-semibold" 
                  />
                </div>
              </DraggableCardBody>
            </div>

            {/* Card 3: Schedule & Timetable (Tall, Right) */}
            <div className="col-span-12 md:col-span-7">
              <DraggableCardBody
                className="w-full h-[360px] bg-[#FFE066] [background-size:20px_20px] [background-image:linear-gradient(to_right,rgba(28,25,23,0.08)_1px,transparent_1px),linear-gradient(to_bottom,rgba(28,25,23,0.08)_1px,transparent_1px)] p-6 flex flex-col justify-between border-2 border-stone-900 shadow-[4px_4px_0px_0px_rgba(0,0,0,1)]"
              >
                {/* Top Text content */}
                <div className="space-y-3 text-left">
                  <div className="inline-flex items-center gap-1 bg-white border-2 border-stone-900 px-2 py-0.5 rounded-md text-[8px] font-mono font-bold uppercase tracking-wider shadow-[1px_1px_0px_0px_rgba(0,0,0,1)]">
                ...
                <div className="flex justify-end">
                  <svg className="w-32 h-24 text-stone-950" viewBox="0 0 140 120" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
            ...
            {/* Card 4: Chat with PDF (RAG) (Wide, Bottom) */}
            <div className="col-span-12 flex justify-center">
              <DraggableCardBody
                className="w-full bg-[#d3ffd0] [background-size:20px_20px] [background-image:linear-gradient(to_right,rgba(28,25,23,0.07)_1px,transparent_1px),linear-gradient(to_bottom,rgba(28,25,23,0.07)_1px,transparent_1px)] p-6 flex flex-col justify-between transition-shadow duration-300 border-2 border-stone-900 shadow-[4px_4px_0px_0px_rgba(0,0,0,1)]"
              >
                <div className="grid grid-cols-1 sm:grid-cols-12 gap-6 items-stretch">
                  
                  {/* Left Side: Title & Description */}
                  <div className="sm:col-span-7 flex flex-col justify-between items-start text-left gap-6 sm:pr-6 border-b sm:border-b-0 sm:border-r border-stone-900/10 pb-4 sm:pb-0">
                    ...
                    <button className="px-4 py-2 bg-stone-900 text-white font-mono text-[9px] font-black uppercase tracking-wider rounded-lg border-2 border-stone-950 shadow-[2.5px_2.5px_0px_0px_#F26430] hover:translate-x-[-1px] hover:translate-y-[-1px] active:translate-x-[1px] active:translate-y-[1px] active:shadow-none transition-all mt-2">
                      Upload document →
                    </button>
                  </div>

                  {/* Right Side: Desk illustration */}
                  <div className="sm:col-span-5 flex items-center justify-center pt-4 sm:pt-0">
